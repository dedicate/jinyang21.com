		...
		<div class='title'>
			...
			<div class='info'>
				<div class='info-text map-location-city'>
					<ul>
						<li class='selected' data-cityname='xa'>西安</li>
						<li data-cityname='cq'>重庆</li>
						<li data-cityname='cd'>成都</li>
						<li data-cityname='jn'>济南</li>
						<li data-cityname='dg'>东莞</li>
						<li data-cityname='sz'>深圳</li>
						<li data-cityname='wx'>无锡</li>
						<li data-cityname='tj'>天津</li>
						<li data-cityname='bt'>包头</li>
						<li data-cityname='eeds'>鄂尔多斯</li>
						<li data-cityname='cz'>常州</li>
					</ul>
				</div>
			</div>
		</div>
